...
def get_args():
    ...
    parser.add_argument( "--cut_calo",
                         type = str2bool,
                         help = "Whether to use remove the Calo working point from the inputs",
                         required = True )

    parser.add_argument( "--cut_track",
                         type = str2bool,
                         help = "Whether to use remove the Track working point from the inputs",
                         required = True )
...
def main():
    ...
    model.setup_network( cut_calo = args.cut_calo, cut_track = args.cut_track,
                         act = nn.SiLU(),
    ...
    model.run_training_loop( max_epochs = 1000, patience = 25, sv_every = 1000 )
